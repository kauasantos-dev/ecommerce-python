...
def pix(produto):
    while True:
        try:
            preco_digitado = validadores.ValidarProduto.validar_preco(input("Digite o preço do produto: "))
            break
...
def cartao():
    while True:
        try:
            ...
            validadores.ValidarEnderecoECartao.validar_cartao(numero, nome, validade, cvv)
            break
        except ValueError as erro:
            print("Erro: ", erro, " Tente novamente.\n")
            continue
